...
class GetSGBinvestDatailsUseCase {
  final NovoRepository repository;

  GetSGBinvestDatailsUseCase({required this.repository});

  Future<SGBinvestDetailsModel> getSGBinvestDetailsUseCase() async {
    try {
      return await repository.getSGBinvestDetails();
    } catch (e) {
      // Handle or log the error as necessary
      //print('Error in GetSbgMasterDatailsUseCase: $e');
      // Re-throw the exception to be handled by the caller
      throw Exception('Failed to get sbg details');
    }
  }
}
