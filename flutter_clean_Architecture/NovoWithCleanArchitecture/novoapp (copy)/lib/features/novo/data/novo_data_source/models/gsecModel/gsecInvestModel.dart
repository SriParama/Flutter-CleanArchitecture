...
GsecInvestDetailsModel ncbMasterDetailsFromJson(String str) =>
    GsecInvestDetailsModel.fromJson(json.decode(str));

String ncbMasterDetailsToJson(GsecInvestDetailsModel data) =>
    json.encode(data.toJson());

class GsecInvestDetailsModel {
  ...
  factory GsecInvestDetailsModel.fromJson(Map<String, dynamic> json) =>
      GsecInvestDetailsModel(
