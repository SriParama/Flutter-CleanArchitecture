...
SGBorderDetialsModel sgbHistoryFromJson(String str) =>
    SGBorderDetialsModel.fromJson(json.decode(str));

String sgbHistoryToJson(SGBorderDetialsModel data) =>
    json.encode(data.toJson());

class SGBorderDetialsModel {
  ...
  factory SGBorderDetialsModel.fromJson(Map<String, dynamic> json) =>
      SGBorderDetialsModel(
