...
GsecOrderDetailsModel ncbHistoryModelFromJson(String str) =>
    GsecOrderDetailsModel.fromJson(json.decode(str));

String ncbHistoryModelToJson(GsecOrderDetailsModel data) =>
    json.encode(data.toJson());

class GsecOrderDetailsModel {
  ...
  factory GsecOrderDetailsModel.fromJson(Map<String, dynamic> json) =>
      GsecOrderDetailsModel(
