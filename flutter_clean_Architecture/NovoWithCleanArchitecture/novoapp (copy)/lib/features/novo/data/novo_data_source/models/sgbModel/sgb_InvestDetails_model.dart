...
SGBinvestDetailsModel sgbMasterDetailFromJson(String str) =>
    SGBinvestDetailsModel.fromJson(json.decode(str));

String sgbMasterDetailToJson(SGBinvestDetailsModel data) =>
    json.encode(data.toJson());

class SGBinvestDetailsModel {
  ...
  factory SGBinvestDetailsModel.fromJson(Map<String, dynamic> json) =>
      SGBinvestDetailsModel(
